...
- [Front-End React](https://github.com/Atifzada/React_greeting_app) 
...
```
git clone https://github.com/Atifzada/Rails_greeting_app
cd greetings-rails
code .
```
...
Feel free to check the [issues page](https://github.com/Atifzada/Rails_greeting_app/issues).
